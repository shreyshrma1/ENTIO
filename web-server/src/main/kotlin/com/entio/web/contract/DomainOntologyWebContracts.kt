...
public data class WebDomainMigrationResponse(
    ...
    val detectedIris: List<String> = emptyList(),
    val recognizedIris: List<String> = emptyList(),
    val unsupportedIris: List<String> = emptyList(),
    val localExtensionCount: Int = 0,
    val verifiedCurrentRelease: String? = null,
    val historicalRelease: String? = null,
    val provenanceSeedCandidates: List<String> = emptyList(),
    val provenanceSeedingEligible: Boolean = false,
    val openWorkStates: List<String> = emptyList(),
    val openWorkBaselineRetained: Boolean = true,
    val issues: List<String> = emptyList(),
    val proposedProfile: DomainOntologyProfile? = null,
    val activationPreview: com.entio.core.DomainProfileActivationPreview? = null,
    val requiresNormalProposalForStatementMovement: Boolean = true,
